...
- **Bruker du Egendefinert nettselskap, må du fylle inn kapasitetstrinnene fra din egen prisliste.** De ti trinnene vi hadde liggende var en mal uten kilde bak seg, og de er fjernet. Til du har skrevet inn tabellen under Konfigurer, står sju kapasitetsavhengige sensorer som Ukjent, blant dem månedlig nettleie og estimert månedskostnad. Tallene de viste før så riktige ut: på 1.16.0 ga malen et kapasitetstrinn på 400 kroner. Det er ikke en tom sensor du mister, det er et tall vi hadde gjettet.
...
- <!--kort--> **Månedskostnaden lå 64 til 145 kroner for høyt, og faller tilsvarende.** Fastleddet er et fast månedsbeløp, men lå inne i totalprisen som en pris per kWh og ble ganget med forbruket. Nå regnes det som andelen av måneden som har gått, og månedskostnaden lander på fakturaens tall. `daily_cost_kr` falt rundt tre kroner per døgn av samme grunn. Statistikken din får et hakk der de gamle tallene slutter. Se [revalideringen](docs/research/revalidering-l3b-september-2026.md).
...
- <!--kort--> **Månedlig nettleie og Månedlig nettleie total står lavere enn i går midt i måneden, og lander på samme tall som før ved månedsslutt.** De viser nå det bokførte fastleddet, altså den delen av kapasitetsleddet som faktisk har forløpt, i stedet for hele månedsbeløpet fra den 1. Tallet du sammenligner med fakturaen står stille. Se [sensorendringene](docs/research/sensorendringer-l3c-september-2026.md).
...
- **Ti nettselskap har fått nye satser, og seks avrundinger er rettet.** Elinett, Elvenett, Høland og Setskog Elverk, Lysna, Mellom, Nordvest Nett, Norefjell Nett, RK Nett, Sør Aurdal Energi og Telemark Nett endret tariffene sine i juli, august og september, og satsene våre lå igjen på de gamle. Avrundingen traff fire kapasitetstrinn og to energiledd hos Romsdalsnett, Vestmar Nett og Enida, under en krone hver. Tall og kilde per selskap: [satsendringer.md](docs/satsendringer.md).

### Lagt til

- <!--kort--> **Vakthold på input-sensorene, med en ny `binary_sensor` som heter Måledata-problem.** HAN-leseren her lå nede 237 timer i strekk uten at noe sa fra. Nå meldes en entitet som har stått utilgjengelig i mer enn 30 minutter, en energiteller som ikke har økt på mer enn terskelen din (default tre timer), en utløpt spotpris-cache og et forkastet energi-sprang. Varselet forsvinner av seg selv når sensoren er frisk igjen.
