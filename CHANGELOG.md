...
- **Bruker du Egendefinert nettselskap, må du fylle inn kapasitetstrinnene fra din egen prisliste.** De ti trinnene vi hadde liggende var en mal uten kilde bak seg, og de er fjernet. Til du har skrevet inn tabellen under Konfigurer, står sju kapasitetsavhengige sensorer som Ukjent, blant dem kapasitetstrinn, månedlig nettleie, estimert månedskostnad og akkumulert kostnad. Tallene har vært synlige hele tiden og sett riktige ut: på 1.16.0 viste et slikt anlegg kapasitetstrinn 400 kroner og en estimert månedskostnad på 405, begge regnet ut fra malen. Det er ikke en tom sensor du mister, det er et tall vi hadde gjettet.
...
- **Har Home Assistant vært nede en stund, hopper akkumulert kostnad opp igjen ved første oppdatering.** Fastleddet regnes nå som den andelen av måneden kalenderen har gått, ikke som en sum av pollene, så timene installasjonen var borte kommer med i stedet for å mangle. Du trenger ikke gjøre noe, men statistikken får et sprang der nedetiden lå.
- **Månedlig nettleie og Månedlig nettleie total står lavere enn i går midt i måneden, og lander på samme tall som før ved månedsslutt.** De viser nå det bokførte fastleddet, altså den delen av kapasitetsleddet som faktisk har forløpt, i stedet for hele månedsbeløpet fra den 1. Den 15. juni på trinn 3 er det 207,55 kroner lavere, mens differansen ved månedsslutt er under ett øre, så tallet du sammenligner med fakturaen står stille. Se [sensorendringene](docs/research/sensorendringer-l3c-september-2026.md).
