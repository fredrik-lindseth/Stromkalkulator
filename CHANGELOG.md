...
- **Månedskostnaden lå 64 til 145 kroner for høyt, og faller tilsvarende.** Fastleddet er et fast månedsbeløp, men lå inne i totalprisen som en pris per kWh og ble ganget med forbruket. Nå regnes det som andelen av måneden som har gått, og månedskostnaden lander på fakturaens tall. `daily_cost_kr` falt rundt tre kroner per døgn av samme grunn. Statistikken din får et hakk der de gamle tallene slutter. Se [revalideringen](docs/research/revalidering-l3b-september-2026.md).
