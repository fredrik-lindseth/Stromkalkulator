...
Integrasjonen oppretter **5 devices** med totalt **44 sensorer**. Av disse er **~17 aktive** som standard — resten er deaktivert og kan slås på ved behov.

| Device           | Beskrivelse                        | Aktive | Totalt |
|------------------|------------------------------------|--------|--------|
| Nettleie         | Energiledd, kapasitet, avgifter    | 9      | 19     |
| Strømstøtte      | Strømstøtte og totalpris           | 3      | 7      |
| Norgespris       | Norgespris-sammenligning           | 0      | 3      |
| Månedlig forbruk | Forbruk og kostnader denne måneden | 4      | 10     |
| Forrige måned    | Forbruk og kostnader forrige måned | 2      | 5      |
...
Sensorer merket med 🔇 i tabellene under er deaktivert som standard.
