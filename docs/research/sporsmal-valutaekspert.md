...
Et hobbyprosjekt verifiserer norske strømfakturaer mot rådata fra Nord Pool og Norges Bank ([hacs-strømkalkulator](https://github.com/0v-no/hacs-strømkalkulator)). Alle fakturalinjer treffer innenfor noen øre, bortsett fra Norgespris-kompensasjonen, som ligger ~0,5–2 kr unna på en månedsfaktura på ~1500 kr.
