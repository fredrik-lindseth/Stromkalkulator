...
> Løst empirisk 2026-07-06, og aldri sendt. [norgespris-eksakt-match.md](norgespris-eksakt-match.md)
...
Vår forståelse er at Bloomberg BFIX publiserer EUR/NOK-mid hvert 30. minutt, inkludert 12:00 CET. Det er ikke en industri-standard "12:00 fix" som matcher WMR 16:00 London, men det er det enkleste 12:00 CET-snapshotet vi kan hente fra en terminal.
...
Offentlige kilder sier at "strømleverandører bruker typisk Nord Pools offisielle daglige EXR for konvertering". Men data tilsier at BKK *ikke* gjør det, hvis BKK brukte Nord Pool EXR direkte, skulle vår variant A truffet på øret. Den gir -3,25 kr avvik for april.
...
Vår forståelse er at EUR/NOK ATR ligger på ~0,066 i 2026, GARCH-vol 8,2 % annualisert (NYU V-Lab). Et 2t15-vindu skal fange 0,015-0,025 NOK stille / 0,04-0,08 NOK travel. Våre observerte 0,02-0,05 NOK-bevegelser ligger midt i båndet.
...
Vår forståelse er at det er en bilateral spot-RFQ (T+2 FX-spot) mot to motparter. Nord Pool sender RFQ til to banker, tar mid eller dårligste pris, og det blir den offisielle EXR. 0,005-0,015 marge mot interbank-mid er innenfor normal RFQ-spread.
...
Vår forståelse er at 12:00 CET er en likviditetslull for NOK, mellom Asia-close (~11:00 CET) og US-open (~14:30 CET), midt i London/Oslo-lunsj. Bid-ask kan være 2-4× bredere enn i peak-tider. BIS Triennial 2022: NOK = 1,7 % av global FX-turnover, så det er en perifer valuta uansett.
