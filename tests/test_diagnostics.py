...
class FakeCoordinator:
    ...
    def __init__(self, data=None, **overstyr):
        ...
        self.fastledd_metode = "mnd_max_3"
...
class TestPersonvern:
    ...
    def test_ingen_plantede_verdier_i_json(self):
        ...
        entry = FakeEntry(
            data={"installasjonssti": HEMMELIG_STI, "maalepunkt": HEMMELIG_MAALEPUNKT},
    ...
    def test_aliaser_er_ikke_stabile_mellom_to_dumper(self):
        """To dumper fra samme bruker skal ikke kunne kobles av en tredjepart."""
        a = Aliaser()
        b = Aliaser()
...
class TestInnhold:
    ...
    def test_dso_seksjon(self):
        ...
        assert dso["fastledd_metode"] == "mnd_max_3"
